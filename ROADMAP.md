...
| # | Item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Status                                   |
| - | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| 1 | Web-ledger deadline reminders via LINE push — `src/web/notify.ts` pushes to the ledger owner's OWN linked LINE account (`user.lineUserId`); users without a link keep email/console. Needs only `LINE_CHANNEL_ACCESS_TOKEN`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | code done; production E2E pending        |
